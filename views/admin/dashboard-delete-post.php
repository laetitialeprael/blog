...
<section>
	<div class="container">
		...
		<div class="d-flex flex-row border-bottom">
				...
				<a href="/blog/admin/mes-articles/publies" class="text-dark hover-mustard ms-4">
					<div class="h4 py-4 mb-0 pointer hover-mustard">Publié (<?php echo implode($postPublished); ?>)</div>
				</a>
				<a href="/blog/admin/mes-articles/corbeille" class="text-mustard hover-mustard ms-4">
					<div class="h4 py-4 mb-0 border-bottom border-mustard border-4 pointer hover-mustard">Corbeille (<?php echo implode($postDraft); ?>)</div>
				</a>
		</div>
	</div>
</section>
		...
		<div class="row">
			...
			<?php else: ?>
				...
				<div class="col text-center">
					...
					<h4 class="mb-4">Aucun article à la corbeille pour le moment.</h4>
				</div>
